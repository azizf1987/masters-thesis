...
Each is truncated in \texttt{references.bib} to the first author plus ``and others'', which the
\texttt{ieeetr} style renders as ``et al.'' The bibliography style is unchanged.
