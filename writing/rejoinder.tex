...
interactions by construction. A \texttt{\% VERIFY} marker is attached pending a direct read of
the review's limitations section, per the thesis's own citation-verification standard.
